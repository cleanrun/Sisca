...
public class FormNewAssetActivity extends AppCompatActivity {
    ...
    private void getCompany(){
        Call<ResponseIndex<Company>> call = userService.indexCompany(auth, accept);
        call.enqueue(new Callback<ResponseIndex<Company>>() {
            @Override
            public void onResponse(Call<ResponseIndex<Company>> call, Response<ResponseIndex<Company>> response) {
                if(response.isSuccessful()){
            ...
            @Override
            public void onFailure(Call<ResponseIndex<Company>> call, Throwable t) {
    ...
    private void getLocation(){
        Call<ResponseIndex<Location>> call = userService.indexLocation(auth, accept);
