...
public class ModelBase {
    ...
    // Set the commander the model uses
    ...
    // Set the handler for model notifications
            ...
            if(mTaskRunner != null){
                    ...
                    protected void onPostExecute(Void result) {
                        ...
                        if(D){
                            Log.i(getClass().getName(),
                                    String.format("Time taken (ms): %d %.2f",
                                            finishTime.getTime() - mTaskStartTime.getTime(), mLastTaskExecutionDuration));
                        }
                    }
                };
                ...
                try{
                    if(Build.VERSION.SDK_INT >= 11){
                        // Ensure the task are executed serially whatever newer API versions may choose by default
                    ...
                    Log.e(TAG, "performTask : " + e.getMessage());
                    mException = e;
                }
